...
# with command line options: step1 --filein file:step0.root --fileout file:step1.root --mc --eventcontent FEVTDEBUGHLT --datatier GEN-DIGI-RAW --conditions 102X_upgrade2018_realistic_v11 --step DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2018 --nThreads 8 --geometry DB:Extended --era Run2_2018 --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('GEN-DIGI-RAW'),
        filterName = cms.untracked.string('')
    ),
    fileName = cms.untracked.string('file:step1_2.root'),
