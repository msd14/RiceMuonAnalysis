...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file:MSSMD_100k_50mm_1.lhe'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('RiceMuonAnalysis/Configuration/Pythia8_CP5_HadronizerFilter_13TeV_cfi nevts:-1'),
...
process.mygenmuonfilter = cms.EDFilter("FilterSample2GenMu")
process.gen_mu_select = cms.Sequence(process.mygenmuonfilter)
