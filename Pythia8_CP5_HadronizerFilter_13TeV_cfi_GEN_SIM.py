...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file:SimpleMuonAnalyzer/test/unweighted_events.lhe'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Pythia8_CP5_HadronizerFilter_13TeV_cfi nevts:10'),
